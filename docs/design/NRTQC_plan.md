...
|-------|--------|-------------|------------|
| 1 | `feature/nrtqc-config` | Config class, schema, templates | n/a |
| 2 | `feature/nrtqc-utils` | EOS-80 σ₀ + flag utilities | n/a |
...
| n/a | `release/v0.5.0` | CHANGELOG, version bump, release | all |
...
profiles; `tests/test_common_utils_qc_flags.py` for severity aggregation.
