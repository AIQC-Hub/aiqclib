...
class TestBuildModel:
    ...
    def test_read_models(
        self, training_config_001_bo002, training_input_001_bo002, training_dir
    ):
    ...
    def test_build_final_model_without_test_sets(
        self, training_config_001_bo002, training_input_001_bo002
    ):
    ...
    def test_write_empty_predictions(
        self, training_config_001_bo002, training_input_001_bo002
    ):
    ...
    def test_write_models(
        ...
        output_paths = {
            tgt: str(test_output_dir / f"test_model_{tgt}.joblib")
            for tgt in TARGETS_NONEMPTY
        }
        for tgt in TARGETS_NONEMPTY:
...
class TestModels:
    ...
    def test_model_output(
        self, case, training_config_001_bo002, training_input_001_bo002
    ):
    ...
    def test_write_model(
        self, case, training_config_001_bo002, training_input_001_bo002, test_output_dir
    ):
